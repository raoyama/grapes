...
select 
	...
	+ CASE WHEN COALESCE(CZK, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(DKK, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(HKD, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(HUF, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(JPY, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(MXN, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(NOK, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(PLN, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(RUB, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(SEK, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(SGD, 0) > 0 THEN 1 ELSE 0 END
	+ CASE WHEN COALESCE(TRY, 0) > 0 THEN 1 ELSE 0 END
